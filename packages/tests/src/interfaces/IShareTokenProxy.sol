...
interface IShareTokenProxy {
    ...
    function getAdmins(bytes32 feature) external returns (address[] memory);
    ...
    function redeem(RedemptionInputs memory inputs)
        external
        returns (uint256 tokensOut);

    function subscribe(SubscriptionInputs memory inputs)
        external
