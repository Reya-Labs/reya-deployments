...
interface IPeripheryProxy {
    ...
    function executeMatchOrders(PeripheryMatchOrderInputs memory inputs)
        external;

    error InvalidMatchOrders();
...
struct PeripheryMatchOrderInputs {
    uint128 accountId;
    Command[] commands;
    EIP712Signature sig;
}
