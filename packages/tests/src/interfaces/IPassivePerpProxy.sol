...
interface IPassivePerpProxy {
    ...
    function setMarketConfigurationDepth(
        uint128 marketId,
        /* warning: missing UDVT support in source Solidity version; parameter is `UD60x18`. */
        uint256 depthFactor
    ) external;

    function setMarketConfigurationSpread(
        uint128 marketId,
        /* warning: missing UDVT support in source Solidity version; parameter is `UD60x18`. */
        uint256 priceSpread
    ) external;

    function batchSetMarketConfigurationDepth(
        uint128[] calldata marketIds,
        /* warning: missing UDVT support in source Solidity version; parameter is `UD60x18[]`. */
        uint256[] calldata depthFactors
    ) external;

    function batchSetMarketConfigurationSpread(
        uint128[] calldata marketIds,
        /* warning: missing UDVT support in source Solidity version; parameter is `UD60x18[]`. */
    ...
    function getMarketData(uint128 marketId)
        external
        view
        returns (MarketDataResponse memory);
}
