...
interface IOrdersGatewayProxy {
    ...
    event SuccessfulFill(
        uint256 fillIndex,
        ConditionalOrderDetails accountOrder,
        ConditionalOrderDetails counterpartyOrder,
        FillDetails fillDetails,
        bytes output,
        uint256 blockTimestamp
    );
    event FailedFillBytes(
        uint256 fillIndex,
        ConditionalOrderDetails accountOrder,
        ConditionalOrderDetails counterpartyOrder,
        FillDetails fillDetails,
...
struct SignedMatchingEnginePayload {
    FillDetails fillDetails;
    EIP712Signature signature;
}

struct ExecuteFillInput {
    ConditionalOrderDetails accountOrder;
    ConditionalOrderDetails counterpartyOrder;
