...
contract WbtcCollateralForkTest is ReyaForkTest, WbtcCollateralForkCheck {
    ...
    function test_wbtc_global_collateral_config() public view {
        check_wbtc_global_collateral_config();
    }

    function test_wbtc_spot_market_config() public view {
    ...
    function test_wbtc_spot_market_enabled() public view {
        check_wbtc_spot_market_enabled(WBTC_SPOT_MARKET_ID);
    }

    function test_wbtc_auto_exchange_enabled() public view {
