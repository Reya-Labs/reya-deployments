...
contract ReyaForkTest is FundingRatePerpOBForkCheck {
    constructor() {
        ...
        // network
        sec.REYA_RPC = string.concat("https://rpc-reya-network.t.conduit.xyz/", rpcKey);
        ...
        sec.srusdRusd_RRStorkNodeId = 0x32f26558cf58400f4fb9d925bae9a91f28816c9fe8abff41df3ff6e1edd99dd0;
        vm.prank(sec.multisig);
        ...
        sec.pumpUsdMarkNodeIdStork = 0x0ae80fc9144b78405fbff18283bf7fe210b1e9e4340f122a209fa0889fc40fe3;
        sec.pumpUsdcMarkNodeIdStork = 0x54615ef8ad9923c95432c8562a5e2e5f45288af9310c7ac1d68d93ab10719601;
        vm.prank(sec.multisig);
        ...
        sec.morphoUsdMarkNodeIdStork = 0xcd97cc663952d46b724f301cbb2d2f1af90858e031101897d66a52fbee78ddd5;
        sec.morphoUsdcMarkNodeIdStork = 0x50699f9c8988e19ba73b92d6fe077d93721ca12c16c76f7d9567a2363159f476;
        vm.prank(sec.multisig);
        ...
        sec.syrupUsdMarkNodeIdStork = 0xf65cb58285233a0d73f7254caaa2c0f2572843bf84570f71d79a9f7c4bc392d2;
        sec.syrupUsdcMarkNodeIdStork = 0x870290df23c90a99934dd53f77f24fa0fd72e2c36c811ba9a2f3dfc4275bdb68;
        vm.prank(sec.multisig);
        ...
        sec.aeroUsdMarkNodeIdStork = 0x584ff6f3716008944e37f5d3ad499a960a4b2d741ec1eba4ae6329959e777479;
        sec.aeroUsdcMarkNodeIdStork = 0xa5e54753386a13d0928c4e76f0691c224bf3ab5e10b262b56a87051a6ddaf0d0;
        vm.prank(sec.multisig);
        ...
        sec.kaitoUsdMarkNodeIdStork = 0x7f931741107ac0e8474c0a1653f371a57d44d7e684430d4a2d49bcd30f8b9ae7;
        sec.kaitoUsdcMarkNodeIdStork = 0xf46088b6abd22bdca88dded2e0c97b08c0c53b0966fe6d115263cc2ae5075252;
        vm.prank(sec.multisig);
        ...
        sec.zoraUsdMarkNodeIdStork = 0x9c3b5bfe2c8fcfbc9f56059e7898760a846759549acec17299190b5a8582dff1;
        sec.zoraUsdcMarkNodeIdStork = 0x6e823df13374d3cb18cf650f98d6d27a49b8dbd09909259d8d334df800649199;
        vm.prank(sec.multisig);
        ...
        sec.proveUsdMarkNodeIdStork = 0x993ead693937d2003ae419b37d0fbf5ef0c12844b046fddde4f243fb34ec3d5a;
        sec.proveUsdcMarkNodeIdStork = 0x64c8d25d7360b50120c266538275df1c4dd97eace89be6549379dafa85de54f5;
        vm.prank(sec.multisig);
        ...
        sec.yzyUsdMarkNodeIdStork = 0xc84a6363d4f6e58b8a50d3ebfc386ed253ef4269657a5286f2cf0f202fbb9334;
        sec.yzyUsdcMarkNodeIdStork = 0x43eebfeaa821974414b73aaa00a791e82ca44b0f45e4e6eebf70d4613c88167b;
        vm.prank(sec.multisig);
        ...
        sec.wlfiUsdMarkNodeIdStork = 0x07d1274610ea7a3075deda63f5a44524060630a960fa394eaad4976392f69b2b;
        sec.wlfiUsdcMarkNodeIdStork = 0x92bf9179ff2aea93779a06684734f7e2c7332ff692c8fa4a78095cf5da784573;
        vm.prank(sec.multisig);
        ...
        sec.lineaUsdMarkNodeIdStork = 0xc4ae9933a147966f829bb421bcc5b62ce46d1bc4ed17ade4366c4ee36b8d633c;
        sec.lineaUsdcMarkNodeIdStork = 0xae60c4ea62b7f410895a867f307546f484c3e6231b6c2fb5e84f7233df98c013;
        vm.prank(sec.multisig);
        ...
        sec.megaUsdMarkNodeIdStork = 0xcf9a311ec86f46b1861d945625e03138758215a1b800300543a0047b415cb511;
        sec.megaUsdcMarkNodeIdStork = 0x4ceda4ce233ca32ac33ed277432d643378c8d7741ebc0e0c4bf42745d5f60b25;
        vm.prank(sec.multisig);
        ...
        dec.socketConnector[sec.usdc][polygonChainId] = 0x2aF7a52C1fe0Ef66af0a65d32c6ab4112Db393ED;
        ...
        // (*) replay the W1 market-close multisig batches — the exact multiSend calldata sent from the
        //     Gnosis Safe 0x40A2aCCbd92BCA938b02010E17A5b8929b49130D on mainnet. Executing the raw bytes
        //     (rather than re-encoding the sub-calls) is what actually exercises the batches: if the
        //     calldata is wrong (target, selector, market id, account list, truncated sub-tx), the
        //     downstream `test_W1MarketsAreFrozen` / `test_W1MarketsAreClosed` assertions catch it.
        //
        //     On mainnet the Safe DELEGATECALLs MultiSendCallOnly, so the sub-CALLs run with
        //     `msg.sender == Safe`. `_replayGnosisMultiSend` reproduces that on the fork by snapshotting
        //     sec.multisig's runtime code, `vm.etch`ing a MultiSendCallOnly-equivalent harness in its
        //     place, calling sec.multisig with the verbatim calldata, then restoring the Safe's own
        //     code. Storage is untouched. Freeze and force-close are owner-only, so routing sub-CALLs
        //     through the etched harness is what makes them reach perp as the owner.
        //
        //     Fresh prices around each batch: `freezeMarketForClosure` and `forceCloseMarket` both read
        //     oracle nodes (mark for freeze snapshot, mark + collateral for close settlement), and the
        //     fork's Stork feeds go stale past the pinned block.

        // The replays below are gated on live state: both batches were EXECUTED from the Safe on
        // mainnet (21 Aug 2026). On a fork pinned after execution, replaying double-executes —
        // `freezeMarketForClosure` and `forceCloseMarket` both call `ensureEnabledMarket` and revert
        // `FeatureUnavailable` on the already-disabled markets, killing every suite in the
        // constructor. The replay only exists to exercise the exact multiSend calldata while the
        // batches were PENDING; once the chain shows the end state (ZRO disabled = batch 2 landed),
        // the live fork already IS the post-close world and `test_W1MarketsAreFrozen` /
        // `test_W1MarketsAreClosed` assert it directly.
        if (isMarketActive(15)) {
            // Batch 1 — freeze the 17 closing markets (17 `freezeMarketForClosure(uint128)` sub-CALLs to
            // sec.perp, one per market in `w1FrozenMarkets`).
            mockFreshPrices();
            _replayGnosisMultiSend(
                //solhint-disable-next-line max-line-length
                hex""
            );

            // Batch 2 — force-close every position and disable each market (17 pairs of
            // `forceCloseMarket(uint128,uint128[],uint256)` + `setFeatureFlagDenyAll(bytes32,bool)` on
            // sec.perp, `maxResidualBase = 1e9`). Account lists match `w1CloseAccounts` in
            // reya_network/trade/MarketClose.fork.t.sol; `test_W1MarketsAreClosed` asserts the end state.
            mockFreshPrices();
            _replayGnosisMultiSend(
                //solhint-disable-next-line max-line-length
                hex""
            );
        }
    ...
    ///         delegate-called MultiSendCallOnly. See the multi-line comment in the constructor for why
    ///         this is done via `vm.etch` rather than a plain call.
    /// @dev Must be called from inside `vm.startPrank(sec.multisig)` (or with `sec.multisig` otherwise
    ///      pranked as the caller) so that the self-call to sec.multisig has msg.sender == sec.multisig.
    function _replayGnosisMultiSend(bytes memory transactions) internal {
        MultiSendCallOnlyHarness harness = new MultiSendCallOnlyHarness();
        bytes memory safeCode = sec.multisig.code;
        vm.etch(sec.multisig, address(harness).code);
        (bool ok, bytes memory ret) = sec.multisig.call(transactions);
        vm.etch(sec.multisig, safeCode);
        if (!ok) {
            assembly {
...
/// @notice Byte-for-byte reproduction of Gnosis Safe's `MultiSendCallOnly.multiSend`, used to replay a
///         real on-mainnet multisig batch verbatim on the fork.
/// @dev The harness has no storage of its own, so it is safe to `vm.etch` its runtime bytecode over a
///      Gnosis Safe address for the duration of one call — the Safe's storage is preserved, only its
///      code slot is temporarily swapped. Sub-CALLs execute with `address(this) == etchedAddress`, so
///      `msg.sender` at the target equals the Safe address, matching the mainnet delegatecall path.
