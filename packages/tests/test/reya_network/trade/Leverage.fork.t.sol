...
contract LeverageForkTest is ReyaForkTest, LeverageForkCheck {
    ...
    function test_trade_rusdCollateral_leverage_pump() public {
    ...
    function test_trade_rusdCollateral_leverage_mega() public {
    ...
    function test_trade_rhedgeCollateral_leverage_aave() public {
        check_trade_leverage(9, sec.rhedge);
    }

    function test_trade_wstethCollateral_leverage_crv() public {
