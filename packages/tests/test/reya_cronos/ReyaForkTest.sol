...
contract ReyaForkTest is BaseReyaForkTest {
    constructor() {
        ...
        sec.sreya = 0xecab1c86ecf1100Ad3aa7A2C175aEDe4c87E949B;
        sec.reya = 0xBD96BE24f68C5e616FF22ffC32715Ffa1C4B70d0;

        // Layerzero configuration
        sec.lzDstEid = 40_161;
        sec.layerZeroEndpoint = 0x6C7Ab2202C98C4227C5c46f1417D81144DA716Ff;
        ...
        vm.prank(sec.multisig);
        IPassivePerpProxy(sec.perp)
            .setFeatureFlagAllowAll(0x1e7fed13f60f1960fdaf304238873e3216743817f5d35b1b5ba1d877e2092be3, true);
        vm.prank(sec.multisig);
        IPassivePerpProxy(sec.perp)
            .setFeatureFlagAllowAll(0xd94fe6b0d28029e9b0bc2853dfd3d4ebeaf71dc48257f547d22f3fb421c01ee8, true);
