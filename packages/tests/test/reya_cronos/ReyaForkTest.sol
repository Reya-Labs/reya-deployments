...
contract ReyaForkTest is BaseReyaForkTest {
    constructor() {
        ...
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.rusdUsdNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.usdcUsdStorkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.ethUsdStorkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.ethUsdcStorkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.usdeUsdStorkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.usdeUsdcStorkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.susdeUsdStorkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.susdeUsdcStorkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.wstethUsdStorkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.wstethUsdcStorkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.deusdUsdStorkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.deusdUsdcStorkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.sdeusdDeusdStorkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.sdeusdUsdcStorkNodeId, 0);

        sec.srusdRusd_RRStorkNodeId = 0xcc867342fbbfce6e175732b29429746f7116343e9aa1813471105e5d2e3061bd;
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.srusdRusd_RRStorkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.rseliniUsdcReyaLmNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.ramberUsdcReyaLmNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.rhedgeUsdcReyaLmNodeId, 0);

        sec.srusdUsdcPoolNodeId = 0xc380c1273590e190bc15a196fdb2b5750abdd0eeb868cc8385dd384761e21ddb;
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.srusdUsdcPoolNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.ethUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.ethUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.btcUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.btcUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.solUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.solUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.arbUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.arbUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.opUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.opUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.avaxUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.avaxUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.mkrUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.mkrUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.linkUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.linkUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.aaveUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.aaveUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.crvUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.crvUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.uniUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.uniUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.suiUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.suiUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.tiaUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.tiaUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.seiUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.seiUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.zroUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.zroUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.xrpUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.xrpUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.wifUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.wifUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.pepe1kUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.pepe1kUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.popcatUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.popcatUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.dogeUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.dogeUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.kshibUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.kshibUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.kbonkUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.kbonkUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.aptUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.aptUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.bnbUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.bnbUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.jtoUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.jtoUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.adaUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.adaUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.ldoUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.ldoUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.polUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.polUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.nearUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.nearUsdcStorkMarkNodeId, 0);
        ...
        // vm.prank(sec.multisig);
        // IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.ftmUsdStorkMarkNodeId, 0);
        // vm.prank(sec.multisig);
        // IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.ftmUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.ftmUsdStorkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.ftmUsdcStorkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.enaUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.enaUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.eigenUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.eigenUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.pendleUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.pendleUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.goatUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.goatUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.grassUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.grassUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.kneiroUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.kneiroUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.dotUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.dotUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.ltcUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.ltcUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.pythUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.pythUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.jupUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.jupUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.penguUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.penguUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.trumpUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.trumpUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.hypeUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.hypeUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.virtualUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.virtualUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.ai16zUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.ai16zUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.aixbtUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.aixbtUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.sonicUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.sonicUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.fartcoinUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.fartcoinUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.griffainUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.griffainUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.wldUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.wldUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.atomUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.atomUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.apeUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.apeUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.tonUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.tonUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.ondoUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.ondoUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.trxUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.trxUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.injUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.injUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.moveUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.moveUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.beraUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.beraUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.layerUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.layerUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.taoUsdStorkMarkNodeId, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.taoUsdcStorkMarkNodeId, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.ipUsdMarkNodeIdStork, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.ipUsdcMarkNodeIdStork, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.meUsdMarkNodeIdStork, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.meUsdcMarkNodeIdStork, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.pumpUsdMarkNodeIdStork, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.pumpUsdcMarkNodeIdStork, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.morphoUsdMarkNodeIdStork, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.morphoUsdcMarkNodeIdStork, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.syrupUsdMarkNodeIdStork, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.syrupUsdcMarkNodeIdStork, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.aeroUsdMarkNodeIdStork, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.aeroUsdcMarkNodeIdStork, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.kaitoUsdMarkNodeIdStork, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.kaitoUsdcMarkNodeIdStork, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.zoraUsdMarkNodeIdStork, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.zoraUsdcMarkNodeIdStork, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.proveUsdMarkNodeIdStork, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.proveUsdcMarkNodeIdStork, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.paxgUsdMarkNodeIdStork, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.paxgUsdcMarkNodeIdStork, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.yzyUsdMarkNodeIdStork, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.yzyUsdcMarkNodeIdStork, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.xplUsdMarkNodeIdStork, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.xplUsdcMarkNodeIdStork, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.wlfiUsdMarkNodeIdStork, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.wlfiUsdcMarkNodeIdStork, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.lineaUsdMarkNodeIdStork, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.lineaUsdcMarkNodeIdStork, 0);
        ...
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.megaUsdMarkNodeIdStork, 0);
        vm.prank(sec.multisig);
        IOracleManagerProxy(sec.oracleManager).setMaxStaleDuration(sec.megaUsdcMarkNodeIdStork, 0);
