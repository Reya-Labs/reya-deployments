...
contract ReyaCollateralForkTest is ReyaForkTest, ReyaCollateralForkCheck {
    ...
    function test_Cronos_reya_global_collateral_config() public view {
        check_reya_global_collateral_config();
    }

    function test_Cronos_reya_spot_market_config() public view {
    ...
    function test_Cronos_reya_spot_market_enabled() public view {
