...
contract SreyaCollateralForkTest is ReyaForkTest, SreyaCollateralForkCheck {
    ...
    function test_Cronos_sreya_global_collateral_config() public view {
        check_sreya_global_collateral_config();
    }

    function test_Cronos_sreya_spot_market_config() public view {
    ...
    function test_Cronos_sreya_spot_market_disabled() public view {
