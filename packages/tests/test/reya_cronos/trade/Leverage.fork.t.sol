...
contract LeverageForkTest is ReyaForkTest, LeverageForkCheck {
    ...
    function test_Cronos_trade_rusdCollateral_leverage_pump() public {
        check_trade_leverage(63, sec.usdc);
    }

    function test_Cronos_trade_rusdCollateral_leverage_morpho() public {
        check_trade_leverage(64, sec.usdc);
    }

    function test_Cronos_trade_rusdCollateral_leverage_syrup() public {
        check_trade_leverage(65, sec.usdc);
    }

    function test_Cronos_trade_rusdCollateral_leverage_aero() public {
        check_trade_leverage(66, sec.usdc);
    }

    function test_Cronos_trade_rusdCollateral_leverage_kaito() public {
        check_trade_leverage(67, sec.usdc);
    }

    // note: market ZORA is closed and fully unwound
    // function test_Cronos_trade_rusdCollateral_leverage_zora() public {
    //     check_trade_leverage(68, sec.usdc);
    // }

    // note: market PROVE is closed and fully unwound
    // function test_Cronos_trade_rusdCollateral_leverage_prove() public {
    ...
    // function test_Cronos_trade_rusdCollateral_leverage_yzy() public {
    //     check_trade_leverage(71, sec.usdc);
    // }

    // note: market XPL is closed and fully unwound
    // function test_Cronos_trade_rusdCollateral_leverage_xpl() public {
    //     check_trade_leverage(72, sec.usdc);
    // }

    // note: market WLFI is closed and fully unwound
    // function test_Cronos_trade_rusdCollateral_leverage_wlfi() public {
    //     check_trade_leverage(73, sec.usdc);
    // }

    function test_Cronos_trade_rusdCollateral_leverage_linea() public {
        check_trade_leverage(74, sec.usdc);
    }

    function test_Cronos_trade_rusdCollateral_leverage_mega() public {
        check_trade_leverage(75, sec.usdc);
    }
